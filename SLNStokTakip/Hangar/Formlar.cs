...
namespace SLNStokTakip.Hangar
{
    class Formlar
    {
        ...
        #region Stok Durum İşlemleri

        public int StokDurum(bool secim = false)
        {
        ...
        public int UrunCikisListesiLot(bool Secim=false)//Lotbul butonuna tıkladığımızda sayfa açılması için bu kodu yazdık..
        {
        ...
        public int UrunCikisBul(bool Secim = false)//Lotbul butonuna tıkladığımızda sayfa açılması için bu kodu yazdık..
        {
